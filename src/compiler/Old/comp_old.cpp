...
int main(int argc, char** argv) {
  ...
  while( (opt = getopt(argc, argv, "so:a:heI:O:g")) != -1 ) {
    switch(opt) {
      case 's':
        compile = false;
        break;
...
// TODO: Use correct exit codes on errors. 
  ...
  of << "\t.string \"%llu\"" << endl;
  of << "debug:" << endl;
  of << "\t.string \"(%lld, cell %llu, %llu cells)\n\"" << endl; 
  ...
  of << "debug_print:" << endl;
  of << "\tmov $0, %rax" << endl;
  of << "\tlea debug(%rip), %rdi" << endl;
  of << "\tmovq (%r12), %rsi" << endl;
  of << "\tmovq %r12, %rdx" << endl;
  of << "\tsubq %r13, %rdx" << endl;
  of << "\tshrq $3, %rdx" << endl;
  of << "\tmovq %r14, %rcx" << endl;
  of << "\tcall printf" << endl;
  of << "\tret" << endl;
  of << "main:" << endl;
